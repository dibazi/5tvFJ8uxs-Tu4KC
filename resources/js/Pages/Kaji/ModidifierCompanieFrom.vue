                                    ...
                                    <div class="bg-white rounded-xl shawdow-lg p-8 text-gray-600">
                                        ...
                                        <form @submit.prevent="updateCheck()" action="" class="flex flex-col space-y-4 contact-form">
                                            ...
                                            <div class="contact-form-success alert alert-success mt-4" v-if="success">
                                                ...
                                                <p class="text-green-700">Bravo!!! votre anonce a ete creee voir click  <strong><inertia-link  class="text-bleu-500" href="/p/o">ici.</inertia-link></strong>. </p>
                                            ...
                                            <div>
                                                <label for="job.province" class="text-sm">Province/Region </label>
                                                <input name="job.province" id="job.province" v-model="job.province" type="text" placeholder="Province/Region ou le post est disponible" required class="ring ring-gray-300 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-teal-300">
                                                <div v-if="hasErrors('job.province')">
                                            ...
                                            <div>
                                                ...
                                                <datepicker lang="fr" format="YYYY-MM-dd" name="job.dateFinal" id="job.dateFinal" v-model="job.dateFinal" required  type="text" placeholder="Date final depot de candidature Exp. 21/02/2021" class="ring ring-gray-300 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-teal-300" />                                                <div v-if="hasErrors('job.dateFinal')">
